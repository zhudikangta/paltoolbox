window.PT_WALLPAPER_PRESETS = [
    { id: 'image-bg', label: '默认壁纸', type: 'image', src: '../游戏内容/幻兽帕鲁/界面资源/壁纸/bg.jpg' },
    { id: 'image-01', label: '帕鲁蓝天', type: 'image', src: '../游戏内容/幻兽帕鲁/界面资源/壁纸/palworld-wallpaper-01.png' },
    { id: 'image-02', label: '森林据点', type: 'image', src: '../游戏内容/幻兽帕鲁/界面资源/壁纸/palworld-wallpaper-02.png' },
    { id: 'title-bg', label: '标题背景', type: 'image', src: '../游戏内容/幻兽帕鲁/界面资源/壁纸/T_title_BG.png' }
];
