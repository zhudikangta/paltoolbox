var PT_ITEM_COMMON = (function() {
    ...
    function getSubCategories(core) {
        if (!core) return [];
        return core.getSubCategories(state.mainCategory);
    }
...
if (typeof window !== 'undefined') window.PT_ITEM_COMMON = PT_ITEM_COMMON;
